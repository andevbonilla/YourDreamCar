  ...
  return (
    <main className={`${josefin.className} bg-black text-white text-opacity-85 md:text-xl`}>
      ...
      <section className='md:px-32 md:pb-16 flex flex-col items-center text-center px-8 pb-12'>
          <h2 className={`font-bold text-2xl pb-12 underline decoration-green-400 underline-offset-8`}>About us</h2>
          <About />
      </section>
      {/* services section */}
      <section className='md:pb-16 flex flex-col items-center text-center pb-12'>
          <h2 className={`font-bold text-2xl pb-12 underline decoration-green-400 underline-offset-8`}>Services</h2>
          <Services />
      </section>
      
      {/* ubication section */}
      <section className='md:pb-16 flex flex-col items-center text-center'>
           <h2 className={`font-bold text-2xl pb-12 underline decoration-green-400 underline-offset-8`}>Where find Us?</h2>
           <Map />
      </section>
    </main>
  )
