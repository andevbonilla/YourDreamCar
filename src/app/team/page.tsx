...
const teamPage = () => {
  return (
    <main className={`${josefin.className} flex flex-col md:px-32 bg-black text-white text-opacity-85 md:text-xl px-10 text-center h-full`}>
        
        <div className='flex flex-col items-center pb-8 text-start md:flex-row md:items-start max-w-3xl mt-24'>
